...
export const DesignationExpenseMappingDialog = ({ open, onClose, asPanel = false }: Props) => {
  ...
  const handleAdd = () => {
    ...
    mutate({
      id: 0,
      designationId: Number(form.designationId), expenseTypeId: Number(form.expenseTypeId),
      amountRangeFrom: Number(form.amountRangeFrom), amountRangeTo: Number(form.amountRangeTo),
